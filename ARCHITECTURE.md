...
- 패키지: `drover==0.2.19`, `drover-sdk==0.2.19`
...
{
  "schema_version": 1,
  "source_sha256": "d6cfbbcaacd1b753417f3ab1cfdcc1f8617ba20f5172e31e8febcad7ce0882f9",
  "reviewed_at": "2026-09-14T13:11:32Z",
  "summary": "Reviewed pending auth, guard, CI and catalog documentation. No-header Keystone introspection preserves scope and root/versioned URL support; explicit rescope and admin/owner policy remain unchanged. Guard timestamp generation supports system Python 3.9 without dependencies. Auth and guard regressions plus SDK verification passed; no topology or schema impact."
}
```
